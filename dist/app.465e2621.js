    ...
    _createClass(App, [{
        ...
        value: function searchBGG(query) {
            ...
            fetch('http://api.collectio.jp/bggapi/search?query=' + encodeURIComponent(query) + '&type=boardgame', {
                ...
                console.log(r);
                if (r.status === 'ok') {
                    if (r.data.items.total == 0) {} else if (r.data.items.total == 1) {
                        var game = r.data.items.item;
                        console.log(game.name.value);
                        _this3.search(game.id);
                        _this3.setState({ games: [game] });
                    } else {
                        r.data.items.item.map(function (game) {
                            console.log(game);
                            _this3.search(game.id);
                        });
                        _this3.setState({ games: r.data.items.item });
                    }
                }
            });
        }
        ...
        value: function search(id) {
            ...
            var url = 'https://db.collectio.jp/wp-json/wp/v2/posts?filter[bgg]=etitle&filter[meta_value]=https://boardgamegeek.com/boardgame/' + id;
            fetch(url, {
                mode: 'cors'
            }).then(function (r) {
                return r.json();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { action: '', ref: 'form' },
                    _react2.default.createElement('input', { type: 'text', name: 'q', ref: 'q', value: this.state.query, onChange: function onChange() {
...
},{"react":"node_modules\\react\\index.js","react-dom":"node_modules\\react-dom\\index.js"}],"..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/app.465e2621.map