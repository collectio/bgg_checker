  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      this.refs.form.addEventListener('submit', function (e) {
        ...
        _this2.searchBGG(_this2.state.query);
      });
      this.refs.q.focus();
    }
  }, {
    key: "searchBGG",
    value: function searchBGG(query) {
      var _this3 = this;
      ...
      fetch("https://api.collectio.jp/bggapi/search?query=".concat(encodeURIComponent(query)), {
        mode: 'cors'
      }).then(function (r) {
        return r.json();
      }).then(function (r) {
        ...
        if (r.status === 'ok') {
          if (r.data.items.total == 0) {
            _this3.setState({
              message: '見つかりませんでした',
              showCreateButton: _this3.refs.q.value
            });
          } else {
            var games;
            ...
            _this3.setState({
              games: games,
              message: r.data.items.total + '件見つかりました'
            }, function () {
              _this3.search(games[0]);
            });
          }
        }
      });
    ...
    key: "changeGames",
    value: function changeGames(id, callback) {
    ...
    key: "search",
    value: function search(game) {
      var _this4 = this;

      // console.log(game)
      this.changeGames(game.id, function (game) {
        game.linkTitle = '[検索中...]';
      });
      var url = "https://db.collectio.jp/wp-json/wp/v2/posts?filter[bgg]=etitle&filter[meta_value]=https://boardgamegeek.com/boardgame/" + game.id;
      fetch(url, {
        mode: 'cors'
      }).then(function (r) {
        return r.json();
        ...
        // console.log(r)
        if (r.length > 0) {
          var dbgame = r[0]; // console.log(dbgame);

          _this4.changeGames(game.id, function (game) {
            game.linkTitle = '[' + dbgame.title.rendered + ']';
            game.href = "https://db.collectio.jp/wp-admin/post.php?post=".concat(dbgame.id, "&action=edit");
          });
        } else {
          fetch("https://api.collectio.jp/bggapi/thing?id=".concat(game.id), {
            mode: 'cors'
          }).then(function (r) {
            return r.json();
          }).then(function (r) {
            ...
            if (r.status === 'ok') {
              var bgggame = r.data.items.item;
              console.log(bgggame);
              var title = bgggame.name.length === 1 ? bgggame.name.value : bgggame.name[0].value;
              title = encodeURIComponent(title);

              _this4.changeGames(game.id, function (game) {
                game.linkTitle = '[なし→新規追加]';
                game.href = "https://db.collectio.jp/wp-admin/post-new.php?post_title=".concat(title, "&etitle=").concat(title, "&year=").concat(bgggame.yearpublished.value, "&bgg=").concat('https://boardgamegeek.com/boardgame/' + game.id, "&playingTime=").concat(bgggame.minplaytime.value, "&minPlayers=").concat(bgggame.minplayers.value, "&maxPlayers=").concat(bgggame.maxplayers.value, "&playAge=").concat(bgggame.minage.value);
              });
            }
          });
        }
      ...
      return _react.default.createElement("div", null, _react.default.createElement("form", {
        ...
        onChange: function onChange() {
          return _this5.setState({
            query: _this5.refs.q.value
          });
        }
      }), _react.default.createElement("button", null, "\u691C\u7D22")), _react.default.createElement("p", null, "\u203B\u30B2\u30FC\u30E0\u540D\u306E\u5225\u540D\u3067\u30D2\u30C3\u30C8\u3059\u308B\u30B1\u30FC\u30B9\u304C\u3042\u308B\u306E\u3067\u6CE8\u610F"), _react.default.createElement("div", {
        className: "games"
      }, this.state.message ? _react.default.createElement("p", null, this.state.message) : null, this.state.games && this.state.games.map(function (game) {
        return _react.default.createElement("div", {
          className: "game",
          key: game.id
        }, game.name.value, " - ", game.yearpublished ? game.yearpublished.value : '', "\xA0", _react.default.createElement("a", {
          ref: game.id,
          href: game.href,
          target: "_blank"
        }, game.linkTitle ? game.linkTitle : _react.default.createElement("button", {
          onClick: _this5.search.bind(_this5, game)
        }, "\u691C\u7D22")));
      }), this.state.showCreateButton ? _react.default.createElement("ul", null, _react.default.createElement("li", null, _react.default.createElement("a", {
        href: "https://db.collectio.jp/wp-admin/edit.php?post_type=post&s=".concat(encodeURIComponent(this.state.showCreateButton)),
        target: "_blank"
      }, "\u300C", this.state.showCreateButton, "\u300D\u3092\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9\u3067\u691C\u7D22")), _react.default.createElement("li", null, _react.default.createElement("a", {
        href: "https://www.google.co.jp/search?q=".concat(encodeURIComponent(this.state.showCreateButton)),
        target: "_blank"
      }, "\u300C", this.state.showCreateButton, "\u300D\u3092Google\u3067\u691C\u7D22")), _react.default.createElement("li", null, _react.default.createElement("a", {
        href: "https://db.collectio.jp/wp-admin/post-new.php?post_title=".concat(encodeURIComponent(this.state.showCreateButton), "&etitle=").concat(encodeURIComponent(this.state.showCreateButton)),
        target: "_blank"
      }, "\u300C", this.state.showCreateButton, "\u300D\u3067\u65B0\u898F\u4F5C\u6210"))) : null));
    }
  }]);
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js"}],"C:/Users/deguc/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/deguc/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.jsx"], null)
