...
},{}],"node_modules\\schedule\\tracing.js":[function(require,module,exports) {
'use strict';
        ...
        value: function search(game) {
            ...
            fetch(url, {
                ...
                if (r.length > 0) {
                    var dbgame = r[0];
                    console.log(dbgame);
                    _this4.refs[game.id].href = 'https://db.collectio.jp/wp-admin/post.php?post=' + dbgame.id + '&action=edit';
                    _this4.refs[game.id].innerHTML = '[' + dbgame.title.rendered + ']';
                } else {
                    fetch('https://api.collectio.jp/bggapi/thing?id=' + game.id, {
                        ...
                        if (r.status === 'ok') {
                            ...
                            console.log(bgggame);
                            var title = encodeURIComponent(bgggame.name.value);
                            _this4.refs[game.id].href = 'https://db.collectio.jp/wp-admin/post-new.php?post_title=' + title + '&etitle=' + title + '&bgg=' + ('https://boardgamegeek.com/boardgame/' + game.id) + '&playingTime=' + bgggame.playingtime.value + '&minPlayers=' + bgggame.minplayers.value + '&maxPlayers=' + bgggame.maxplayers.value + '&playAge=' + bgggame.minage.value;
                            _this4.refs[game.id].innerHTML = '[なし→新規追加]';
                        }
                    });
                }
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { action: '', ref: 'form' },
                    _react2.default.createElement('input', { type: 'text', name: 'q', ref: 'q', autoComplete: 'off', value: this.state.query, onChange: function onChange() {
                            return _this5.setState({ query: _this5.refs.q.value });
                        } }),
                    _react2.default.createElement(
                        'button',
                        null,
                ...
                _react2.default.createElement(
                    ...
                    this.state.games && this.state.games.map(function (game) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'game', key: game.id },
                            game.name.value,
                            ' - ',
...
},{"react":"node_modules\\react\\index.js","react-dom":"node_modules\\react-dom\\index.js"}],"C:\\Users\\deguc\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/app.aabf3a3b.map