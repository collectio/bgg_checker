...
document.querySelector('form').addEventListener('submit', function (e) {
    e.preventDefault();
    search(document.querySelector('input[name="q"]').value);
});

_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('app'));

var ComponentCollectio = function (_Component) {
    _inherits(ComponentCollectio, _Component);

    function ComponentCollectio() {
        _classCallCheck(this, ComponentCollectio);

        var _this = _possibleConstructorReturn(this, (ComponentCollectio.__proto__ || Object.getPrototypeOf(ComponentCollectio)).call(this));

        _this.state = {};
        return _this;
    }

    _createClass(ComponentCollectio, [{
        key: 'render',
...
//# sourceMappingURL=/app.a2cc8d06.map